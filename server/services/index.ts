...
import { TestimonialEngine } from "#server/services/entities/testimonials";
import { StatisticsEngine } from "#server/services/misc/statistics";
...
export const TestimonialService = new TestimonialEngine();

export const StatisticService = new StatisticsEngine();
